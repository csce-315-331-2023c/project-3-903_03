...
<div style="width: 100%; height: 100%; background: #D9D9D9">
    ...
    <form style="text-align: center" action="/action_page.php">
        ...
        <input type="text" id="uname" name="username" onchange="updateUser()"><br><br>
        <label for="pword">password:</label>
        <input type="password" id="pword" name="password" onchange="updatePass()"><br><br>
        <input type="submit" value="Login" style="margin-bottom: 20px; background:white"> 
        <input type="submit" value="Create New Account" onclick="load()" style="background:#63C5DA">
    </form>
</div>
